                    ...
                    <div class="navbar">
                        <div class="container-xl">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item {{ request()->is('manifests*') ? 'active' : null }}">
                                    <a class="nav-link" href="{{ route('manifests.index') }}" >
                                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                ...
                                <li class="nav-item {{ request()->is('shipments*') ? 'active' : null }}">
                                ...
                                <li class="nav-item {{ request()->is('containers*') ? 'active' : null }}">
                            ...
                            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                                <ul class="list-inline list-inline-dots mb-0">
                                    <li class="list-inline-item">
                                        ...
                                        <a href="." class="link-secondary">Tranz Pacific Shipping</a>.
                                        All rights reserved.
                                    </li>
                                    <li class="list-inline-item">
